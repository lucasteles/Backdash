...
namespace Backdash.Tests.Specs.Network.Messages;
...
public class MessageSerializationTests
{
    ...
    [PropertyTest]
    internal bool InputMsgSerialize(InputMsg value) => AssertSerialization.Validate(ref value);

    [PropertyTest]
    internal bool InputMsgOffset(InputMsg value) => AssertSerialization.Offset(ref value);
}
