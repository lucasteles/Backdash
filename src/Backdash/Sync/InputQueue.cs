...
sealed class InputQueue<TInput> where TInput : struct
{
    ...
    readonly FrameArray<GameInput<TInput>> inputs;
    ...
    public Frame GetFirstIncorrectFrame()
    {
        lock (locker)
    ...
    void AddDelayedInputToQueue(ref GameInput<TInput> input, Frame frameNumber)
    {
